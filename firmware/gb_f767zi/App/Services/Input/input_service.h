...
extern "C"
{
  ...
  static const input_button_hw_t buttonMap[] = {
    { INPUT_KEY_TEST, BOARD_INPUT_INT_USER },   { INPUT_KEY_UP, BOARD_INPUT_EXT_UP },
    { INPUT_KEY_DOWN, BOARD_INPUT_EXT_DOWN },   { INPUT_KEY_LEFT, BOARD_INPUT_EXT_LEFT },
    { INPUT_KEY_RIGHT, BOARD_INPUT_EXT_RIGHT }, { INPUT_KEY_OK, BOARD_INPUT_EXT_OK },
  };
